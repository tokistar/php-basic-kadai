            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                ...
                <div class="carousel-caption d-none d-md-block">
                  <img src="<?php echo get_template_directory(); ?>/images/logo_big_slide.png" />
    ...
    <div class="news">
      <div class="footer_row">
        <div class="row news_row">
            ...
            <div class="news_post_small">
              <div class="row news_post_row">
                ...
                <div class="col-lg-9 col-md-8 col-sx-12">
                  <div class="news_post_small_title">
                    <a href="events_detail.html"><?php the_title(); ?></a>
                  </div>
          ...
          <!-- 卒業生の声 -->
          <div class="col-lg-6 col-md-6 col-sx-12 news_col">
            <div class="home_title">graducates</div>
